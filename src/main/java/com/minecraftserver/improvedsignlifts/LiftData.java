...
public class LiftData implements Serializable {
    ...
    public LiftData(Location loc, List<String> members) {
        this.location = new LocationSerializable(loc.getWorld().getName(), loc.getX(), loc.getY(), loc.getZ(),
    ...
    public Location getLocation() {
        return new Location(Bukkit.getWorld(location.world), location.x, location.y, location.z, location.yaw,
                            location.pitch);
    }
