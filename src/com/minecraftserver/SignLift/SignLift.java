...
public class SignLift extends JavaPlugin {
    ...
    private final SignLiftBlockListener blockListener = new SignLiftBlockListener(
	    this);
    private final SignLiftPlayerListener playerListener = new SignLiftPlayerListener(
	    this);
	...
	defaultGoingDownString = cfg.getString("string.down.default",
		"Going Down");
	goingUpStringFormat = cfg.getString("string.up.format", "Going to %s");
	goingDownStringFormat = cfg.getString("string.down.format",
		"Going to %s");
	...
	log("Improved Sign Lifts - Version " + pdfFile.getVersion()
		+ " is enabled");
